...
\geometry{a4paper,total={180mm,267mm},left=15mm,top=15mm,} % Custom margins
...
\renewcommand{\thesubsection}{} % Change the dot point for sections in table of contents 
...
\newcommand{\SectionTitle}[2]{\noindent \hspace{0.5mm} {\xhrulefill{antiquewhite}{8.0mm}}

 \vspace{-8mm}\noindent 
 {\hspace{2mm}\ \large{#1 #2}}
}
...
\setlength{\cftsecindent}{10pt}% Remove indent for \section
\setlength{\cftsubsecindent}{15pt}% Remove indent for \subsection
